...
export const allowedChains = [1, 42, 56, 97]
...
export const chainsConfig: ChainConfig[] = [
  ...
  },
  {
    ...
    networkTokenSymbol: 'ETH',
    pinataBaseUrl: 'https://nftfypinningservice.azurewebsites.net/api/uploadMedia',
    etherscanAddress: 'https://kovan.etherscan.io/',
    bscScanAddress: 'https://testnet.bscscan.com/',
    name: 'kovan',
    infuraAddress: `https://kovan.infura.io/v3/${infuraKey}`,
    zeroXBaseUrl: 'https://api.0x.org',
    nftfyNftBaseUrl: 'https://api.thegraph.com/subgraphs/id/Qmaip3cyrURr35Dvacsb9Fee7BeGe2G2CTDXsBZFuuovUq',
    nftfyMetaBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmdNWSbmvaurd1xK9j7JqySXek4hHA2hRxkp9Te3fqjZhC',
    nftfyFracBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmbKDigFfUb83JrUHtBcuWBnzsPeCMa6yeQmk43JzQSXdj',
    nftfy2FracBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmW8s7i8KE9QN5JZFcLeeo3wagQYNirp5ZBC9YaPyjriWE',
    nftfyPeerToPeerBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmbMnZYdLqSTazNJvkxE4YZ9tdSqoy9ZQJGEyAHU73RLaA',
    bscNodeAddress: `https://white-lively-surf.bsc.quiknode.pro/${quickNodeKey}`,
    ethAddress: '0x0000000000000000000000000000000000000000',
    masterChefAddress: '0xebf2aa932bFF40053091Bc4000E45ACDD76492c7',
    boxAddress: '0xFc44f66D5D689cD9108c6577533E9572f53a50Bc',
    mint: {
      minterAddress: '0x62cF87B0E441e6E3A1634304AbA6332F3Fd6464F',
      defaultCollectionAddress: '0x9c8a2b35B268bf2AA69f5fc105514e34daF3cEBb'
    ...
    peerToPeerAddress: '0x91FE09bB4D060abc2FD1460f87D19c4c9410448e',
    nftfyTokenAddress: '0x8279BE8f740DBeDB05C0Ce165447E8bc1457a137',
    nftfyAuctionAddress: '0x5EF37b60C374634Ff917BaafECB515Bf1482cAc3',
    nftfyTokenDecimals: 18,
    stableCoinAddress: '0x6b175474e89094c44da98b954eedeac495271d0f',
    stableCoinDecimals: 18,
    ...
    balancer: {
      ...
      subgraphBackupUrl: 'https://storageapi.fleek.co/balancer-bucket/balancer-exchange-kovan/pools',
      eth: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE',
      ...
      poolsUrl: 'https://kovan.pools.balancer.exchange/'
    },
    ens: {
      subgraphUrl: '',
      contractAddress: '',
    ...
    box: {
      subgraphUrl: 'https://api.thegraph.com/subgraphs/id/QmVfBB72tzy8ArFuNRVf2aFEP3YQp7TbcAh1rBMTh1PJLb',
      contractAddress: '0xFc44f66D5D689cD9108c6577533E9572f53a50Bc',
      symbol: 'BOX'
    },
    pools: {
      managementUrl: 'https://kovan.pools.balancer.exchange/#/pool',
      createUrl: 'https://kovan.pools.balancer.exchange/#/',
      chartColors: ['#FF7070', '#FFB1AD', '#FF7470', '#FF5463', '#FF99AA', '#595B5F', '#8C8F95', '#AAADB3', '#C4C8CD', '#D9DEE2'],
      main: ['0x1528f3fcc26d13f7079325fb78d9442607781c8c', '0x2f375e94fc336cdec2dc0ccb5277fe59cbf1cae5'], // DAI and USDC tokens Kovan
      lbp: ['0xfdf7f21eda1fb8aebed2fc8b0e8f72a8f17cf823'], // DAI Kovan
      fundsBpt: []
    },
    assets: [],
    bridge: {
  ...
  },
  {
    ...
    infuraAddress: `https://mainnet.infura.io/v3/${infuraKey}`,
    zeroXBaseUrl: 'https://bsc.api.0x.org',
    bscNodeAddress: `https://bsc-dataseed.binance.org/`,
    ethAddress: '0x0000000000000000000000000000000000000000',
    masterChefAddress: '',
    nftfyFracBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmPdQUat8aqaXEwdVC3wButQyGBgMZXvE3da6MtTzZsddM',
    nftfy2FracBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmTXBgNuxY4Vz5j8DfUnq7tqAKxpYXc9bujcAw2aWvWXvg',
    nftfyNftBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmUqzyQ1hEKk9qyaD9Hrp7VwJzhN3dUXGopVowLbwN9ACC',
    nftfyMetaBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmPKR11j8tkCJFPLa3SHpRvaX7ViyFkeKfWsUg6x53WF9f',
    nftfyPeerToPeerBaseUrl: '',
    nftfyTokenAddress: '0xBf6Ff49FfD3d104302Ef0AB0F10f5a84324c091c',
    nftfyTokenDecimals: 18,
    nftfyAddress: '0x8279BE8f740DBeDB05C0Ce165447E8bc1457a137',
    nftfyAuctionAddress: '0x5EF37b60C374634Ff917BaafECB515Bf1482cAc3',
    ...
    box: {
      subgraphUrl: 'https://api.thegraph.com/subgraphs/id/QmZUqKyQn4aNo8Xf4c4ywVQvwgUs5CLN3tjuQpC79WcJK3',
      contractAddress: '0xFc44f66D5D689cD9108c6577533E9572f53a50Bc',
      symbol: 'BOX'
    },
    pools: {
  ...
  },
  {
    ...
    infuraAddress: `https://mainnet.infura.io/v3/${infuraKey}`,
    zeroXBaseUrl: '',
    bscNodeAddress: `https://data-seed-prebsc-1-s1.binance.org:8545/`,
    ethAddress: '0x0000000000000000000000000000000000000000',
    masterChefAddress: '',
    nftfyFracBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmXp1DeomoWS8Sk3RQq6oNtA9czrZwRH8abHpCHqJyH2VD',
    nftfy2FracBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmVjecaxPTQEwCaFuqD13cvBnLkPfbV6cnVXKGnFx7kq59',
    nftfyPeerToPeerBaseUrl: '',
    nftfyNftBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmWBTJJqq1QFeeHzL4ef11WW5z6jVy4DwsdYgRq8KbJHEw',
    nftfyMetaBaseUrl: 'https://api.thegraph.com/subgraphs/id/QmdDnp5ynkBemSQ1pBrJTAL1uAj7w3NRWjSxqfUEGHezXL',
    nftfyTokenAddress: '0xBf6Ff49FfD3d104302Ef0AB0F10f5a84324c091c',
    nftfyTokenDecimals: 18,
    nftfyAddress: '0x8279BE8f740DBeDB05C0Ce165447E8bc1457a137',
    nftfyAuctionAddress: '0x5EF37b60C374634Ff917BaafECB515Bf1482cAc3',
