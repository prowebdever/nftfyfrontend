...
export default function MarketplaceDetailsPage() {
  ...
  const { address, routeChainId, type } = useParams<{ address: string; routeChainId?: string | undefined; type?: string | undefined }>()
  ...
  if (type && type === MarketplacePageType.listing) {
    return <CollectiveBuyMarketplaceDetailsPage address={address} account={account} selectedChainId={selectedChainId} />
  }

  return <DefaultMarketplaceDetailsPage account={account} address={address} selectedChainId={selectedChainId} />
}
