  ...
  return (
    <S.Container className={className}>
      ...
      <S.ContainerInfos>
        ...
        <a rel='noreferrer' target='_blank' href={`https://opensea.io/assets/${collectionId}/${tokenId}`}>
          <span>View on open sea</span>
          <img src={external} alt='redirect' />
        </a>
        <a rel='noreferrer' target='_blank' href={`${etherscanAddress}/address/${collectionId}`}>
