...
import supplyIcon from '../../assets/icons/money-coins.svg'
import reservePriceIcon from '../../assets/icons/reserve-price.svg'
...
export const PeerToPeerTradeSaveModal = () => {
  ...
  useEffect(() => {
    const handleTotal = async () => {
      ...
      const totalDollar = quoteNewTotalDollar.priceDollar === '' ? 0 : Number(quoteNewTotalDollar.priceDollar.replaceAll(',', ''))
  ...
  useEffect(() => {
    const getBalance = async () => {
      if (account && peerToPeerTradeData?.erc20.id) {
        const erc20Balance = await getErc20Balance(account, peerToPeerTradeData?.erc20.id, peerToPeerTradeData?.erc20.decimals, chainId)
...
const S = {
        ...
        > div {
          ...
          > div {
            ...
            &.error {
              ...
              .ant-input {
                border-color: ${colorsV2.red.light};
              }
  ...
  Input: styled(Input)`
    ...
    &:disabled {
      ...
      box-shadow: none;
      outline: none;
      background-color: ${colorsV2.gray['1']};
      text-align: right;
      padding-right: 16px;
      height: 40px;
    }
